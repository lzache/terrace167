...
define( 'DURGA_VERSION', '1.1.0' );

if ( ! function_exists( 'durga_setup' ) ) {
	add_action( 'after_setup_theme', 'durga_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function durga_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'durga' );
		...
		add_theme_support( "custom-background",
			array(
				...
				'default-image'          => get_template_directory_uri().'/img/pattern.jpg',
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'durga' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in durga_smart_content_width()
		 */
...
define('DURGA_THEME_URL','https://wpkoi.com/durga-wpkoi-wordpress-theme/','durga');
define('DURGA_WPKOI_AUTHOR_URL','https://wpkoi.com/','durga');
define('DURGA_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/','durga');
define('DURGA_WORDPRESS_REVIEW','https://wordpress.org/support/theme/durga/reviews/?filter=5','durga');
define('DURGA_DOCUMENTATION','https://wpkoi.com/docs/','durga');